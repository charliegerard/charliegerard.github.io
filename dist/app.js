...
router.on('route:projectsView', function(){
  ...
  projectsData[0].web.forEach(function(project){
    list.push(new __WEBPACK_IMPORTED_MODULE_0__models_projectModel__["a" /* default */]({title: project.title, image: project.image, url: project.url, description: project.description, projectDescription: project.projectDescription}))
  })
