		...
		"web": [
			...
			},
			{
				...
				"projectDescription": {
					...
					"technology": [
						"The Myo armband is a wearable gesture control and motion control device that senses electrical signals going through the user's arm and connects to the computer via bluetooth. Built in Node.js, this project "
					],
